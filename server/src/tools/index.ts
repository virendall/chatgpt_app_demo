...
import { registerDoctorSearchTool } from './doctor-search.js'
...
export function registerAllTools(server: McpServer) {
    ...
    registerDoctorSearchTool(server)
...
export { registerDoctorSearchTool } from './doctor-search.js'
...
export { DOCTOR_SEARCH_RESOURCE_URL } from './doctor-search.js'
